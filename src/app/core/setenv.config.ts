...
export const environment = {
  ...
  apiKey: '${process.env['API_KEY'] || 'gNlVN7pIkc5OK412NgbtL9xpl3vEB9xi3VlvJ8yu'}',

  // ========== API Gateway Comunes (HTTP Proxy) ==========
  apiGatewayComunes: {
    dev: '${process.env['API_GATEWAY_COMUNES_DEV'] || 'https://fz73xehwah.execute-api.us-east-1.amazonaws.com/dev/persona_administracion'}',
  ...
  apiKeyComunes: '${process.env['API_KEY_COMUNES'] || process.env['API_KEY'] || 'gNlVN7pIkc5OK412NgbtL9xpl3vEB9xi3VlvJ8yu'}',
