...
export class PolicyInputComponent implements OnInit {
  ...
  actualizarValorAsegurado(valorFormateado: string, cob: any): void {
    ...
    this.recalcularPrimaCobertura(cob);
  }
  ...
  // ✅ Coberturas RC con mismo formato que Coberturas Cumplimiento
  rcCoberturas = [
    { id: 1, nombre: 'VEHI.PROPIOS Y NO VIGEN.', porcentaje: 100, valorAsegurado: 150000000, tasa: 2.4, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 3675000, seleccionada: false },
    { id: 2, nombre: 'VEHI.PROPIOS Y NO VEHIC.', porcentaje: 100, valorAsegurado: 150000000, tasa: 2.3, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 3525000, seleccionada: false },
    { id: 3, nombre: 'PREDIOS LABOR.Y OPERACIO/PLO', porcentaje: 100, valorAsegurado: 150000000, tasa: 2.0, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 3000000, seleccionada: false },
    { id: 4, nombre: 'PATRONAL VIGENCIA', porcentaje: 100, valorAsegurado: 150000000, tasa: 1.9, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 2925000, seleccionada: true },
    { id: 5, nombre: 'PATRONAL PERSONA', porcentaje: 100, valorAsegurado: 150000000, tasa: 1.85, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 2775000, seleccionada: false },
    { id: 6, nombre: 'GASTOS MEDICOS VIGENCIA', porcentaje: 100, valorAsegurado: 150000000, tasa: 1.8, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 2775000, seleccionada: true },
    { id: 7, nombre: 'GASTOS MEDICOS PERSONA', porcentaje: 100, valorAsegurado: 150000000, tasa: 1.75, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 2625000, seleccionada: true },
    { id: 8, nombre: 'CRUZADA', porcentaje: 100, valorAsegurado: 150000000, tasa: 2.2, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 3375000, seleccionada: true },
    { id: 9, nombre: 'CONTRATISTA Y SUBCONTRATISTA', porcentaje: 100, valorAsegurado: 150000000, tasa: 2.15, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 3225000, seleccionada: true },
    { id: 10, nombre: 'CONTAMINACION ACCIDENTAL', porcentaje: 100, valorAsegurado: 150000000, tasa: 2.4, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 3675000, seleccionada: true },
    { id: 11, nombre: 'BIENES BAJO CUIDADO TENE', porcentaje: 100, valorAsegurado: 150000000, tasa: 1.95, fechaInicio: '2024-08-01', tiempoAdicional: 30, fechaFin: '2025-07-31', fechaVencimiento: '2025-08-30', prima: 2925000, seleccionada: true },
  ];
  ...
  toggleTodasCoberturasRC(event: any): void {
    ...
    this.rcCoberturas.forEach(c => c.seleccionada = checked);
  }
  ...
  onCampoRCCambio(cob: any): void {
    ...
    // Fórmula RC: Prima = Valor Asegurado * Porcentaje / 100 * Tasa / 100
    cob.prima = Math.round((valorAsegurado * porcentaje / 100) * (tasa / 100));
    
    console.log('🔥 Prima RC:', cob.nombre, '→', cob.prima);
    this.cdr.detectChanges();
  }
  ...
  recalcularPrimaRC(cob: any): void {
    ...
    // Fórmula RC: Prima = Valor Asegurado * Porcentaje / 100 * Tasa / 100
    let prima = (valorAsegurado * porcentaje / 100) * (tasa / 100);

    cob.prima = Math.round(prima);
    console.log(`📊 Prima RC recalculada: ${cob.nombre} → $${this.formatearNumero(cob.prima)}`);
    console.log(`🔄 Prima RC recalculada para ${cob.nombre}: ${cob.prima}`);
  }
  ...
  liquidarPrimaRC(): void {
    ...
    for (const cob of coberturasSeleccionadas) {
      if (this.coberturasAnterioresIdsRC.includes(cob.id) && this.valoresAnterioresRC[cob.id]) {
        ...
        if (anterior.porcentaje !== cob.porcentaje) {
          cambios.push(`% Asegurado: ${anterior.porcentaje}% → ${cob.porcentaje}%`);
        }
  ...
  actualizarValorAseguradoRC(value: string, cob: any): void {
    const cleanValue = value.replace(/\./g, '').replace(/,/g, '');
    cob.valorAsegurado = parseInt(cleanValue, 10) || 0;
    this.recalcularPrimaRC(cob);
  }
  ...
  onTipoCoaseguroChange(): void {
    if (this.tipoCoaseguro === 'cedido') {
      ...
      // Participación queda vacía, el usuario la edita manualmente
      this.coasegurosCedidos = [
        {
          coaseguradora: this.COASEGURADORA_BOLIVAR,
          participacion: '', // Vacío como en el sistema viejo
          gastosAdmin: 0,
          numeroPol: '',
          certificado: '',
